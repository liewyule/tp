...
public class JsonAdaptedApplicationTest {
    ...
    public void toModelType_invalidCompany_throwsIllegalValueException() {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(INVALID_COMPANY, VALID_PHONE, VALID_APPLICATION_DATE,
    ...
    public void toModelType_nullCompany_throwsIllegalValueException() {
        JsonAdaptedApplication application = new JsonAdaptedApplication(null, VALID_PHONE, VALID_APPLICATION_DATE,
                VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY, INVALID_PHONE, VALID_APPLICATION_DATE,
                        VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidApplicationDate_throwsIllegalValueException() {
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY, VALID_PHONE, INVALID_APPLICATION_DATE,
                        VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullApplicationDate_throwsIllegalValueException() {
        JsonAdaptedApplication application = new JsonAdaptedApplication(VALID_COMPANY, VALID_PHONE, null,
                VALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedApplication application =
            new JsonAdaptedApplication(VALID_COMPANY, VALID_PHONE, VALID_APPLICATION_DATE, INVALID_ADDRESS, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedApplication application = new JsonAdaptedApplication(VALID_COMPANY, VALID_PHONE,
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedApplication application =
                new JsonAdaptedApplication(VALID_COMPANY, VALID_PHONE, VALID_APPLICATION_DATE,
