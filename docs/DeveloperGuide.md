...
`find` filters the displayed application list using one or more of the following prefixes: `c/COMPANY`, `r/ROLE`, `d/DATE`, `s/STATUS`. At least one prefix must be provided.
...
1. Finding applications while all applications are being shown
    ...
    6. Other incorrect find commands to try: `find`, `find c/`, `find d/2025-12-12`, `find x/Google`  
